...
| File | Coverage |
|------|----------|
| [[file:src/features/tenders/quick_reference.org][src/features/tenders/quick_reference.org]] | 13 components, 5 hooks for tender list/detail |
...
| [[file:src/components/quick_reference.org][src/components/quick_reference.org]] | Layout, shared, UI components (15 total) |
| [[file:src/lib/quick_reference.org][src/lib/quick_reference.org]] | Supabase client, 23 TypeScript types, pages, contexts |
| [[file:src/features/auth/quick_reference.org][src/features/auth/quick_reference.org]] | 3 components, 1 hook for login/auth |
