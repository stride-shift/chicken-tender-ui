      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 px-8 pb-10">
        ...
        <div>
          ...
          <input
            ...
            disabled={isLoading}
            className="h-10 w-full rounded-md bg-input px-3 py-2 text-sm border border-border focus:ring-2 focus:ring-ring focus:outline-none transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              disabled={isLoading}
              className="h-10 w-full rounded-md bg-input px-3 py-2 text-sm border border-border focus:ring-2 focus:ring-ring focus:outline-none transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed pr-10"
            />
            <button
              type="button"
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full h-10 rounded-md bg-primary text-primary-foreground font-bold hover:bg-primary/90 shadow-sm transition-all duration-200 mt-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
        >
